...
/*   Updated: 2022/03/10 22:53:30 by hgoorick         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const name, std::string const target, int gradeSign, int gradeExec) : _name(name), _target(target), _sign(false)
{
